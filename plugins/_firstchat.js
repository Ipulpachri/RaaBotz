...
*Powered By @${global.owner[1].split('@')[0]}*`
    ...
        await conn.send3ButtonLoc(m.chat, 'https://telegra.ph/file/1cb4d3690c4aee0c42903.jpg', ` ${ucapan()}, @${m.sender.split`@`[0]}
 ${user.banned ? 'kamu dibanned' : `
Saya Adalah FachriBotz, Bot What'sapp Yang Bisa Anda Gunakan Untuk Membuat Sticker, Mendownload Sesuatu, Bermain Game, Dll.
