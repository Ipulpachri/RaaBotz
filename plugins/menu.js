...
Saya Adalah FachriBotz Salah Satu Bot Whatsapp Yang Siap Membantu Kamu Mempermudah Sesuatu Seperti Membuat Sticker Dan Lainnya, Kalo Kamu Mau Request Fitur Silahkan Ketik #request Pesan Atau Fitur Yang Kamu Inginkan!`
...
                 .replace(/%islimit/g, menu.limit ? 'Ⓛ' : '')
 ...
         externalAdReply: { 
             title: 'Fachri WhatsappBot MultiDevice', 
 ...
          mediaUrl: `${pickRandom([`https://www.facebook.com/Inunime-107082474576049/`,`https://youtube.com/c/SaefulFahri`])}` 
         } 
      } 
     })*/
...
type: 'audioMessage', 
ptt: true, contextInfo:{ externalAdReply: { title: `💌 UltahFachri : ${ohari} Hari ${ojam} Jam ${onet} Menit ${detek} Detik`, body: `${pickRandom(['Follow My Instagram Plis •~•'])}`, sourceUrl: 'https://www.instagram.com/sfdesign_id/', thumbnail: await (await fetch('https://telegra.ph/file/dffdaf0e8d59ad104e526.jpg')).buffer(),}} 
     })
} catch (e) { 
